package com.wlv.abominodo.controller;
...
import com.wlv.abominodo.models.Location;
import com.wlv.abominodo.serconnection.ConnectionGenius;
import com.wlv.abominodo.serconnection.IOSpecialist;
import com.wlv.abominodo.util.MultiLinugualStringTable;
import com.wlv.abominodo.views.IOLibrary;
import com.wlv.abominodo.views.PictureFrame;

public class Aardvark {

  private String playerName;
  private List<Domino> dl; //dl variable declare as a dl
  private List<Domino> gl; //gl variable declare as a gl
  ...
  private void generateGuesses() {
   gl = new LinkedList<Domino>();
    int count = 0;
  //  int x = 0; Unused variables Considered as a - Bad Smells
  //  int y = 0; Unused variables Considered as a - Bad Smells
      ...
      case 2: {
        ...
        if (!(f.exists() && f.isFile() && f.canRead())) {
          ...
          try {
            ...
            String n = playerName.replaceAll(",", "gc");
            pw.print("Hugh Jass");
            pw.print(",");
            pw.print(1500);
            pw.print(",");
